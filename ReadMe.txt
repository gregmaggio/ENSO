...
java -jar modules/swagger-codegen-cli/target/swagger-codegen-cli.jar generate -i http://localhost:8081/ENSO/api-docs -l dynamic-html -o C:/Dev/Applications/ENSO/src/main/webapp
...
Make sure that you change the log file location to ${catalina.base}/logs/enso.txt